...
export const projects = [
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: '/media/projects/gallery/nyamata-4.jpg', alt: 'Brickwork going up behind timber scaffolding' },
      { src: '/media/projects/gallery/nyamata-5.jpg', alt: 'The frame and brick infill with the crew on site' },
      { src: '/media/projects/gallery/nyamata-6.jpg', alt: 'Brickwork rising behind the scaffolding on the rear elevation' },
      { src: '/media/projects/gallery/nyamata-7.jpg', alt: 'The steel roof frame going up over the finished brickwork' },
    ],
    facts: [
